...
2. `"Hello, World!"`: a sequence of characters known as a string literal.
    - Type: A string (sequence of characters).
    - Value: The specific string "Hello, World!".
...
:::note
Technically, `std::endl` is a [manipulator](https://en.cppreference.com/w/cpp/io/manip/endl), not a sequence of characters. It instructs the output stream to insert a newline character and flush the stream.
:::
