...
description: Learn how to use vim, a powerful terminal-based text editor, with this cheat sheet. This guide covers basic commands, hotkeys, and how to configure vim using a .vimrc file for efficient coding.
---

You can type `vimtutor` in the terminal while connected to the ENGR servers to get a guided tutorial on how to use vim.

Consider learning vim while playing a game: [Vim Adventures](https://vim-adventures.com/)
...
{/* IMPROVE: While 'y12<Enter>' works, the standard way to yank multiple lines is '[count]yy' (e.g., '12yy'). */}
