---
title: Introduction
description: Welcome to the studio sessions for ENGR 103! These hands-on, interactive sessions reinforce lecture concepts through practical exercises. Topics include environment setup, Git, expressions, functions, loops, strings, arrays, and file I/O.
sidebar:
  order: 0
pageActions: false
---
...
**Don't forget to get your TA to sign off on your studio completion at the end of each session.**
