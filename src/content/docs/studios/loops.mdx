...
<div style="display:flex;justify-content:center;margin:1rem 0">
  <svg width="360" height="360" viewBox="-1.1 -1.1 2.2 2.2" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Unit circle inscribed in a square">
    <rect x="-1" y="-1" width="2" height="2" fill="#f6f8fa" stroke="#333" stroke-width="0.02"/>
    <circle cx="0" cy="0" r="1" fill="rgba(66,135,245,0.12)" stroke="#426fb5" stroke-width="0.02"/>
    <line x1="-1" y1="0" x2="1" y2="0" stroke="#666" stroke-width="0.01" stroke-dasharray="0.02,0.02"/>
    <line x1="0" y1="-1" x2="0" y2="1" stroke="#666" stroke-width="0.01" stroke-dasharray="0.02,0.02"/>
    <defs>
      <marker id="arrow" markerWidth="6" markerHeight="6" refX="5" refY="3" orient="auto">
        <path d="M0,0 L6,3 L0,6 z" fill="#c33"/>
      </marker>
    </defs>
    <line x1="0" y1="0" x2=".99" y2="0" stroke="#c33" stroke-width="0.02" marker-end="url(#arrow)"/>
    <text x="0.5" y="-0.08" font-size="0.10" fill="#c33" text-anchor="middle">r = 1</text>
  </svg>
</div>
