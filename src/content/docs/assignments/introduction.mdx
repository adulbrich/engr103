---
title: "Introduction"
description: Welcome to the assignments section for ENGR 103! This guide provides an overview of the assignments designed to help you apply programming concepts to solve real-world problems.
sidebar:
  order: 0
pageActions: false
---
...
1. **[Getting Started](/assignments/getting-started)**: Complete a simple questionnaire to familiarize yourself with the tools and submission process.
2. **[Linear Equations](/assignments/linear-equations)**: Write programs to solve systems of linear equations in different contexts.
3. **[Financial Planner](/assignments/financial-planner)**: Develop a program to help the user decide how much to save or what to invest in.
4. **[Dictionary](/assignments/dictionary)**: Build a terminal interface for a dictionary API to look up word definitions.
5. **[Calculator](/assignments/calculator)**: Create a simple terminal-based calculator supporting basic arithmetic operations.
