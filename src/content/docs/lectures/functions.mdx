...
functions.cpp:9:13: error: no matching function for call to 'sum'
    9 |     cout << sum(2) << endl;
      |             ^~~
functions.cpp:4:8: note: candidate function not viable: requires 2 arguments, but 1 was provided
    4 | double sum(double first_value, double second_value) {
      |        ^   ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
1 error generated.
```
