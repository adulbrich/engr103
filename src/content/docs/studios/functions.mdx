...
Note that this simple implementation assumes <Latex formula="a \leq x \leq b"/>. A robust CDF would return 0 for <Latex formula="x < a"/> and 1 for <Latex formula="x > b"/>.
...
```c++ title="Solution for Example Problem 1"
#include <iostream>
...
```c++ title="Solution for Example Problem 2"
#include <iostream>
