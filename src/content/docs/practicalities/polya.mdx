...
description: Apply Polya's Problem Solving process to your programming assignments. This guide covers understanding the problem, devising a plan, carrying out the plan, and reviewing the solution for effective problem-solving.
---
...
In your programming **code** assignments (when you write the code), focus on:
...
## Simple Problem: Area of a Rectangle
...
- Errors in the user input do not count against the `n` numbers to enter.
...
- `n` the number of test scores to read
- the actual test scores, inputted `n` times

#### Output(s)

- the average (mean) of the `n` test scores
...
```text title="Pseudocode for Test Score Average"
