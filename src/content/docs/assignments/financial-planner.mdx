...
| When are payments made | Timing of periodic payments: beginning or end of period | Two different values | Invalid → notify and override with default (end of period) |

You can use **equation (1)** from above to calculate the future value.

The output will be the future value of the investment or item, formatted as currency, i.e., `$12,345.67` or `$12345.67`.
...
The output will be the present value of the future sum, formatted as currency, i.e., `$12,345.67` or `$12345.67`.
...
The output will be the required recurring payments needed to reach the future value goal, formatted as currency, i.e., `$12,345.67` or `$12345.67`.
...
<div class="print:block hidden italic">The simulator is not printed to PDF. Consult the online textbook to see it.</div>
...
<RubricTable src="canvas/assignments/financial-planner-rubrics.tsv" caption="Financial Planner Rubric" />
