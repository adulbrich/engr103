...
```cpp title="Const Variable Declaration"
...
```cpp title="Constexpr Variable Declaration"
...
```cpp title="Const Initialization at Runtime"
char user_input;
std::cin >> user_input;
...
```cpp title="Pi Constant Declaration"
...
```cpp title="Pi Variable Declaration"
