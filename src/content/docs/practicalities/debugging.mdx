...
```shell title="Compile with Debug Info"
g++ -g -o run debug_cerr.cpp
```

Then run GDB with your compiled program:

```shell title="Start GDB Session"
gdb ./run
```
