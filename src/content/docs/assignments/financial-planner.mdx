...
Here's a small interactive simulator to test your program. You can input values for each scenario and see the expected output. The compounding period is set to yearly.
