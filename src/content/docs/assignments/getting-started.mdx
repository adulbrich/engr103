...
:::note[Prerequisites]
Please complete the [Git and GitHub studio](/studios/git-and-github/) before starting this assignment, as it covers the necessary steps for using Git and GitHub on the ENGR servers.
:::
...
You may find the lecture notes on [development environment](/lectures/development-environment/) and [git and GitHub](/lectures/git/), and the content from the first two studios helpful for this assignment.