...
<div class="print:block hidden italic">The simulators are not printed to PDF. Consult the online textbook to see them.</div>

## Rubric

<RubricTable src="canvas/assignments/linear-equations-rubrics.tsv" caption="Linear Equations Rubric" />