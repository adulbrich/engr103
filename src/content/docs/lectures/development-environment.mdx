...
{/* IMPROVE: While we focus on vim, `nano` is a much simpler editor for beginners. You might want to mention it as an alternative if students find vim too difficult. */}
