...
1. **[Getting Started](../getting-started)**: Complete a simple questionnaire to familiarize yourself with the tools and submission process.
2. **[Linear Equations](../linear-equations)**: Write programs to solve systems of linear equations in different contexts.
3. **[Financial Planner](../financial-planner)**: Develop a program to help the user decide how much to save or what to invest in.
4. **[Dictionary](../dictionary)**: Build a terminal interface for a dictionary API to look up word definitions.
5. **[Calculator](../calculator)**: Create a simple terminal-based calculator supporting basic arithmetic operations.
