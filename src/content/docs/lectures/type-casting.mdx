...
```cpp title="Type Coercion Example"
double x = 3;
```
...
```cpp title="Implicit Type Coercion Example"
...
```plaintext frame="terminal" title="Output of Implicit Type Coercion Example"
3
3.14159265
```
...
```cpp title="Implicit Type Coercion"
...
```cpp title="Explicit Type Casting"
double pi = 3.14159265;
...
```cpp title="Type Casting Order of Operations"
