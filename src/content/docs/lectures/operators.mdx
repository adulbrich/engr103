...
```cpp title="Expression Statement Example"
5;
```
...
```cpp title="Arithmetic Example 1"
#include <iostream>
...
```text frame="terminal" title="Arithmetic Example 1 Output"
15.5
0
```
...
```cpp title="Arithmetic Example 2"
...
```text frame="terminal" title="Arithmetic Example 2 Output"
15
```
...
```text frame="terminal" title="Compilation Error for Invalid Modulo Operation"
...
```cpp title="Math Functions Example"
#include <iostream>
#include <cmath>
...
```text frame="terminal" title="Math Functions Example Output"
32
12
8
```
...
```text frame="terminal" title="Compilation Error Without cmath"
