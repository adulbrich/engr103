...
You can use the following links to test your program with different scenarios:
...
- [Recurring Payments Calculation](https://www.calculator.net/investment-calculator.html?ctype=contributeamount&ctargetamountv=1%2C000%2C000&cstartingprinciplev=20%2C000&cyearsv=10&cinterestratev=6&ccompound=annually&ccontributeamountv=1%2C000&cadditionat1=end&ciadditionat1=monthly&printit=0#calresult)
